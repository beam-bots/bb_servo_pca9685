...
defmodule BB.Servo.PCA9685.MixProject do
  use Mix.Project
  ...
  defp package do
    [
      ...
      licenses: ["Apache-2.0"],
      links: %{
        "Source" => "https://github.com/beam-bots/bb_servo_pca9685",
  ...
  defp docs do
    [
      ...
      source_ref: "main",
      source_url: "https://github.com/beam-bots/bb_servo_pca9685"
    ]
  end
